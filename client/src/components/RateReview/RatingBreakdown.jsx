...
class RatingBreakdown extends React.Component {
  ...
  render() {
    ...
    let pctRecommended = (this.state.countRecommendations / this.props.reviews.length * 100) + '%'
    ...
    return (
      ...
      <div>
        ...
        <div className="ratingBreakdown" style={{ display: this.props.filter.length !== 0 ? "block" : "none" }}>
          ...
          <div className="clearAll" onClick={() => this.props.onClearAllFunc()} ><em>clear all</em></div>
        </div>
        <div className="row"><div className="bar-text">5 stars</div><div className="bar-container" onClick={() => this.props.onToggleFunc(5)}><div className="bar-5" style={pctStyle5}></div></div><div className="bar-text floatRight">{this.state.sumRatingBreakdown['5']}</div></div>
        <div className="row"><div className="bar-text">4 stars</div><div className="bar-container" onClick={() => this.props.onToggleFunc(4)}><div className="bar-4" style={pctStyle4}></div></div><div className="bar-text floatRight">{this.state.sumRatingBreakdown['4']}</div></div>
        <div className="row"><div className="bar-text">3 stars</div><div className="bar-container" onClick={() => this.props.onToggleFunc(3)}><div className="bar-3" style={pctStyle3}></div></div><div className="bar-text floatRight">{this.state.sumRatingBreakdown['3']}</div></div>
        <div className="row"><div className="bar-text">2 stars</div><div className="bar-container" onClick={() => this.props.onToggleFunc(2)}><div className="bar-2" style={pctStyle2}></div></div><div className="bar-text floatRight">{this.state.sumRatingBreakdown['2']}</div></div>
        <div className="row"><div className="bar-text">1 star</div><div className="bar-container" onClick={() => this.props.onToggleFunc(1)}><div className="bar-1" style={pctStyle1}></div></div><div className="bar-text floatRight">{this.state.sumRatingBreakdown['1']}</div></div>
        <br></br>
